...
const ProductDetails = ({ onBuyNow }) => {
  ...
  // Add video reference and state to track if video has been played
  ...
  const handleBuyNowClick = () => {
    ...
    trackButtonClick('Product Buy Now Button', 'Purchase');
  ...
  // Update demo video button to include tracking and actually play the video
  const handlePlayDemoClick = () => {
    trackButtonClick('Play Demo Video', 'Content');
              ...
              <div>
                ...
                <div className="mb-6">
                  <div className="flex items-center space-x-2 mb-1">
                    <p className="text-3xl font-bold text-white">{formatPrice(productDetails.discountPrice)}</p>
                    {productDetails.originalPrice && (
                      <p className="text-lg text-gray-400 line-through">{formatPrice(productDetails.originalPrice)}</p>
                    )}
                  </div>
