        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 sm:gap-10">
          <div>
            <div className="flex items-center mb-4">
              <svg xmlns="http://www.w3.org/2000/svg" className="h-7 w-7 sm:h-8 sm:w-8 mr-2 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="flex space-x-4">
              ...
              <a href="#" aria-label="YouTube" className="text-gray-400 hover:text-blue-500 transition-colors">
                <svg className="h-5 w-5 sm:h-6 sm:w-6" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="mt-8 sm:mt-0">
            <h4 className="font-semibold text-lg mb-4 sm:mb-5 text-blue-400">Product</h4>
          ...
          <div className="mt-8 md:mt-0">
            <h4 className="font-semibold text-lg mb-4 sm:mb-5 text-blue-400">Support</h4>
            <ul className="space-y-2 sm:space-y-3">
