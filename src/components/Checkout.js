...
const Checkout = ({ selectedVariant, quantity, totalPrice, onBack }) => {
  ...
  const processCodOrder = async () => {
    try {
      ...
      // Set payment ID and complete order
      setPaymentId(codPaymentId);
      setOrderComplete(true);
      window.scrollTo(0, 0);
  ...
  const renderStepContent = () => {
    switch(step) {
          ...
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label htmlFor="zipCode" className="block mb-1 font-medium text-gray-700">PIN Code</label>
                  <input
                    type="text"
                    id="zipCode"
                    name="zipCode"
      ...
      case 2:
        return (
          <div>
            <h3 className="text-xl font-medium mb-6">Payment Information</h3>
            ...
            <div className="mb-6">
              ...
              <div className="flex flex-wrap gap-3">
                ...
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 sm:h-6 sm:w-6 mr-2 text-gray-700" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      case 3:
        return (
          <div>
            <h3 className="text-xl font-medium mb-6">Review Order</h3>
  ...
  const renderOrderComplete = () => {
    return (
      <div className="text-center py-8">
        ...
        <p className="text-gray-600 mb-2">We've sent a confirmation email to {formData.email}</p>
        
        {paymentMethod === 'razorpay' && paymentId && (
          <p className="text-gray-600 mb-8">Payment ID: {paymentId}</p>
        )}
        
        {paymentMethod === 'cod' && (
          <div className="p-4 bg-yellow-50 border border-yellow-200 rounded-md max-w-md mx-auto mb-8">
              ...
              <div className="flex items-center justify-between">
                {['Shipping', 'Payment', 'Review'].map((label, index) => (
                  <div key={index} className="flex-1 text-center">
                    ...
                    <div className={`text-sm font-medium ${step === index + 1 ? 'text-blue-600' : 'text-gray-600'}`}>
                      {label}
                    </div>
                  </div>
                ))}
